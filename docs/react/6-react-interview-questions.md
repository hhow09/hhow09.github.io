...
- React has its own `bailout reconciliation mechanism` to skip the re-rendering of a component.
#### Context
- When using Context, React will pass props implicitly to all nodes of subtree.
